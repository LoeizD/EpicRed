...
static struct FScriptStruct_FMODStudioOculus_StaticRegisterNativesFFMODOculusRoomParameters
{
	...
	IMPLEMENT_CLASS(UFMODOculusSettings, 2832005667);
...
// Cross Module References
	...
	UScriptStruct* Z_Construct_UScriptStruct_FFMODOculusRoomParameters()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_RefFar = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefFar"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefFar, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RefNear = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefNear"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefNear, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RefDown = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefDown"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefDown, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RefUp = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefUp"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefUp, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RefRight = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefRight"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefRight, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RefLeft = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefLeft"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefLeft, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RoomDepth = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RoomDepth"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RoomDepth, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RoomHeight = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RoomHeight"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RoomHeight, FFMODOculusRoomParameters), 0x0000000000000001);
			UProperty* NewProp_RoomWidth = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RoomWidth"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RoomWidth, FFMODOculusRoomParameters), 0x0000000000000001);
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODOculusRoomParameters_CRC() { return 2384815442U; }
